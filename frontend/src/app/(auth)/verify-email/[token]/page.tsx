      ...
      <div className="w-full max-w-md text-center">
        ...
        {status === "loading" && (
          <div className="bg-white rounded-2xl shadow-sm border p-8">
            ...
            <p className="text-gray-500">Email megerősítése...</p>
          </div>
        )}
        ...
        {status === "success" && (
          <div className="bg-white rounded-2xl shadow-sm border p-8">
            ...
            <h1 className="text-xl font-bold text-gray-900 mb-2">Email megerősítve!</h1>
            <p className="text-sm text-gray-500 mb-6">Az email címed sikeresen megerősítve. Most már minden funkció elérhető.</p>
            <Link
              href="/dashboard"
        ...
        {status === "error" && (
          <div className="bg-white rounded-2xl shadow-sm border p-8">
            ...
            <h1 className="text-xl font-bold text-gray-900 mb-2">Hiba</h1>
