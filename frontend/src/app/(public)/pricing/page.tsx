...
const plans = [
  ...
  },
  {
    ...
    support: "Email támogatás (36 óra)",
  ...
  },
  {
    ...
    support: "Direkt email támogatás (24 óra)",
  ...
  },
  {
    ...
    support: "Kiemelt Telefon+Email (12 óra)",
    cta: "Ajánlatkérés",
    href: "/register",
    popular: false,
...
const comparisonFeatures: ComparisonRow[] = [
  ...
  { name: "CSV exportálás", kezdo: false, kozepes: true, premium: true, nagyvallalati: true },
  { name: "Tömeges műveletek", kezdo: false, kozepes: false, premium: true, nagyvallalati: true },
  { name: "Arculat testreszabás", kezdo: false, kozepes: false, premium: true, nagyvallalati: true },
  ...
  { name: "Kiemelt támogatás", kezdo: false, kozepes: false, premium: false, nagyvallalati: true },
  { name: "Bevezetés és oktatás", kezdo: false, kozepes: false, premium: false, nagyvallalati: true },
  ...
  { name: "Támogatás válaszidő", kezdo: "72 óra", kozepes: "36 óra", premium: "24 óra", nagyvallalati: "12 óra" },
];
