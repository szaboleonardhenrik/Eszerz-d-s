                ...
                <div className="mt-5 pt-4 border-t border-gray-100">
                  <div className="flex gap-2">
                    ...
                    <p className="text-[11px] text-gray-400 leading-relaxed">
                      Az aláírással hozzájárul, hogy a Legitas (T-DIGITAL Solutions Kft.) az Ön nevét, e-mail címét, IP-címét és böngészőadatait az aláírás hitelesítése céljából kezelje. Részletes tájékoztató:{" "}
                      <a
                        href="/adatvedelem"
                        target="_blank"
